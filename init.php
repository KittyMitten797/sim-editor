...
//	define("SERVER_PROFILES",  SERVER_SCENARIOS . "profiles" . DIRECTORY_SEPARATOR);
	...
	define("BROWSER_HTML", $_SERVER["SERVER_NAME"] . DIRECTORY_SEPARATOR .  $top_dir . DIRECTORY_SEPARATOR);
	define("BROWSER_II", HOST_PROTOCOL . $_SERVER["SERVER_NAME"] . DIRECTORY_SEPARATOR . 'sim-ii' . DIRECTORY_SEPARATOR . 'ii.php' . DIRECTORY_SEPARATOR);
	define("BROWSER_II_REDIRECT", HOST_PROTOCOL . $_SERVER["SERVER_NAME"] . DIRECTORY_SEPARATOR . 'sim-ii' . DIRECTORY_SEPARATOR . 'ii.php');
//	define("BROWSER_HTML", $_SERVER["HTTP_HOST"].DIRECTORY_SEPARATOR);
	define("BROWSER_ROOT", HOST_PROTOCOL . BROWSER_HTML);
	define("BROWSER_PROFILES_IMAGES", HOST_PROTOCOL . $_SERVER["SERVER_NAME"] . DIRECTORY_SEPARATOR . "scenarios" . DIRECTORY_SEPARATOR . "images" . DIRECTORY_SEPARATOR);
	define("BROWSER_CGI",  HOST_PROTOCOL . $_SERVER["SERVER_NAME"] . DIRECTORY_SEPARATOR . "cgi-bin" . DIRECTORY_SEPARATOR);
	define("BROWSER_SCENARIOS", HOST_PROTOCOL . $_SERVER["SERVER_NAME"] . DIRECTORY_SEPARATOR . "scenarios" . DIRECTORY_SEPARATOR);
	...
	define("BROWSER_JS", BROWSER_ROOT . "js" . DIRECTORY_SEPARATOR);
